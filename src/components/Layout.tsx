import { IonButton, IonContent, IonFab, IonFabButton, IonFabList, IonIcon, IonPage, IonRouterLink } from '@ionic/react'
    ...
    return (
        <IonPage>
            ...
            <IonContent fullscreen>
                <IonFab slot="fixed" vertical="bottom" horizontal="end" className='bottom-10 right-5'>
                    <IonFabButton>
