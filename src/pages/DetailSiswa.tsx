...
import { fetchWithToken, parseDate, showToast, standartDate } from "../lib/utils";
...
const DetailSiswa: React.FC<DetailSiswaType> = ({ match }) => {
  ...
  return (
    <SecondLayout header={<SecondaryHeader title={`detail siswa`} />}>
              ...
              <IonLabel>
                <div className="flex flex-col gap-1">
                  ...
                  <span className="text-xs">
                    Menampilkan informasi umum siswa smk cendekia sungai karang
                  </span>
                </div>
              </IonLabel>
            </IonItem>
              ...
              <Card>
                ...
                <div className="flex flex-col gap-7">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <span className="text-sm break-words">{siswa.alamat}</span>
                  </div>
                  <div className="flex flex-col gap-1">
