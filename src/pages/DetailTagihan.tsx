...
const DetailTagihan: React.FC<DetailTagihanType> = ({ match }) => {
  ...
  async function createAndDownloadPDF() {
    ...
    reader.onloadend = async () => {
      ...
      await sendLocalNotification("SMK CSK", `${filename}.pdf telah di download`)
  ...
  return (
    <SecondLayout header={<SecondaryHeader title={`detail tagihan`} />}>
      ...
      <div className="w-full">
        <IonAccordionGroup ref={ref as any}>
          ...
          <IonAccordion value="second">
            ...
            <div className="ion-padding" slot="content">
              <Card className="p-3">{pembayaranView}</Card>
            </div>
          </IonAccordion>
        </IonAccordionGroup>
      </div>
